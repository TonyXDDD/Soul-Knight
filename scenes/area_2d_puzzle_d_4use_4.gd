...
@onready var testdoor: AnimatedSprite2D = $"../PuzzleDoor6"
@onready var static_body_2d: StaticBody2D = $"../PuzzleDoor6/StaticBody2D"
@onready var collision_shape_2d: CollisionShape2D = $"../PuzzleDoor6/StaticBody2D/CollisionShape2D"
@onready var key_2: Sprite2D = $"../Sprite2D6"
