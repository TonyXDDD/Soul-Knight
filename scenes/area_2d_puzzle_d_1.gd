...
@onready var PuzzleDoor1: AnimatedSprite2D = $"../PuzzleDoor1"
@onready var static_body_2d: StaticBody2D = $"../PuzzleDoor1/StaticBody2D"
@onready var collision_shape_2d: CollisionShape2D = $"../PuzzleDoor1/StaticBody2D/CollisionShape2D"
