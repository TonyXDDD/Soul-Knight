...
@onready var testdoor: AnimatedSprite2D = $"../TESTDOOR4"
@onready var static_body_2d: StaticBody2D = $"../TESTDOOR4/StaticBody2D"
@onready var collision_shape_2d: CollisionShape2D = $"../TESTDOOR4/StaticBody2D/CollisionShape2D"
