...
@onready var player: CharacterBody2D = $"../Player"
 # Fade control (a ColorRect or Control node)
@onready var animation_player: AnimationPlayer = $"../Transition2/AnimationPlayer" # Animation player for fade animations
@onready var transition_2: Control = $"../Transition2"



var next_level_scene = "res://scenes/main_menu.tscn"
